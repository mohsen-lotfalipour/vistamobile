<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="checkout-step-2.aspx.cs" Inherits="checkout_step_2" %>
                ...
                <div class="checkout-container">
                    <div class="row">
                    	<div class="span10 offset1">
                    		...
                    		<div class="checkout-steps">
                    		    <div class="clearfix">
                    		    	<div class="step done">
                    		    	    ...
                    		    	    <a href="checkout-step-1.aspx">سبد خرید</a>
                    		    	</div>
							...
							<!--  = Shipping addr form =  -->
							<!--  ==========  -->
							 <p>پر کردن فیلدهای ستاره دار (<span class="red-clr bold">*</span>) الزامی است</p>
                            <hr />   
                 ...
                 <%--               <div class="control-group">
                                 ...
                                 <hr />
						    <p>بعد از ابن مرحله شما میتوانید به وسیله ایمیل و شماره خود به سایت وارد شوید و سفارشات خود را پیگیری کنید</p>
                            <hr />
						    <p class="right-align">
						        در مرحله بعدی شما شیوه پرداخت را انتخاب میکنید &nbsp; &nbsp;
                                <input type="submit"  class="btn btn-primary higher bold" onserverclick="Acceptcart_Click" id="accept_cart_step2" runat="server" clientidmode="Static"  value="ادامه" />
						    </p>
