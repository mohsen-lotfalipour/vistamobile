...
var WebMarketVars = {
    ...
    currencySymbol: "ریال",
    priceRange: [0, 30000000], // minimum and maximum range for the price range selector
    priceStep: 1000000
};
...
jQuery(document).ready(function ($) {
    ...
    */
    ...
    $(document).on("focus", ".large-screen #navSearchInput", function () {
        ...
        repositionLine();
        //$("#livesearch").show();
        $("#livesearch").animate({ opacity: 100 }, 600)
    ...
    var delayhide = function () {
        setTimeout(function () {
            $("#livesearch").animate({ opacity: 0 }, 200)
        }, 200);
    };
    ...
    $(document).on('click', '.item-in-cart .icon-remove-sign', function (e) {
    ...
    $(".table-items .icon-remove-sign").click(function () {
        $(this).parents("tr").animate({
            ...
            var totalprice = parseInt($("#total_price_review").text()); //;parseInt($(this).parent().next().next().text(), 10);
            $("#total_price_review").text((totalprice-number) + "  ریال  ");

        });
        //return false;
    });

    //            $(".table-items .icon-remove-sign").on('click', function (e) {
    //                $(this).parents("tr").animate({
    //                    opacity: 0
    //                }, "swing", function () {
    //                    $(this).remove();
