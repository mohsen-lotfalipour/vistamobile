<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="shop-search.aspx.cs" Inherits="shop_search" %>
            ...
            <div class="row">
                <div class="span12">
                    <ul class="breadcrumb">
                        ...
                        <li><span class="icon-chevron-left"></span></li>
                        <li>
                            <a href="shop-search.aspx">Search Results for &quot;Horsefeathers&quot;</a>
                        </li>
                    </ul>
                </div>
            </div>
